...
```bash
# 开始执行
python3 scripts/kanban_update.py progress JJC-xxx "正在分析人员能力，评估培训需求" "需求分析🔄|方案制定|培训执行|效果评估"

# 方案制定中
python3 scripts/kanban_update.py progress JJC-xxx "培训方案已完成，正在准备教材" "需求分析✅|方案制定✅|教材准备🔄|培训执行"
```
